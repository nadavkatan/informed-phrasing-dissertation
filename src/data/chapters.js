export const chapters = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        content: `It would be an understatement to say that Schenker considered his analytical theory to be relevant to musical performance. From his occasional performance instructions in his analytical and theoretical works<span class="footnote">8</span>, through his editorial publication of Beethoven's Piano Sonatas in Universal edition, to his collection of essays on musical performance, compiled by his disciples to form the book <i>The Art of Performance</i>, Schenker was very explicit about the applicability of his analyses to performance. It is clear that the ultimate objective emerging from these publications is making what Schenker recognized as ‘deep structural lines’ audible in performance. Schenker instructs to utilize any means available to the performer, such as the use of dynamics, articulation, fingerings, hand motion, pedal, hand pedal etc., to effectively resonate the structural interpretation in performance. Nevertheless, it should be noted that Schenker did expect the performer to do so with a certain level of sophistication and subtlety. In his words: "This does not mean that the tones of the fundamental line need be overemphasized, as are the entrances in a poor performance of a fugue. The player who is aware of the coherence of a work will find interpretive means which <strong>allow the coherence to be heard</strong>”<span class="footnote">9</span>.`,
      },
      {
        type: "text",
      ...
      {
        type: "text",
        content: `By instructing how to emphasize the tones of the fundamental line in performance, Schenker essentially considers the <i>sense of coherence</i> as an <i>effect</i>. This <i>effect</i> is, to some extent, of a more abstract nature than notated performance instructions. When it comes to 'a sense of coherence' as an <i>effect</i>, we can infer a hierarchical perception of the concept of <i>effect</i>. In his analytically driven performance instructions, Schenker transforms the higher-level <i>effect</i>: 'a sense of coherence' to a lower level, or perhaps <i>‘middle ground effect’</i> (to borrow Schenker's own terminology) of: 'allow the fundamental line to be heard' which in turn utilizes any conceivable mean of performance to be realized. `,
      },
      {
        type: "figure",
