export const chapters = [
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        content: `The decision to limit the scope of this research project to the <i>phrasing</i> aspect of musical performance was based on considerations of feasibility. It would have been impossible to address the relationship between analysis and every single aspect of musical performance within one research project. Although ‘phrasing’ is a particular means of musical expression with clear functions and objectives, its execution virtually includes all means of musical performance. `,
      },
      {
        type: "text",
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          `This core; the fundamental line, is the component that unifies the tonal composition, it is the component that induces a sense of coherence<span class="footnote">11</span>.`,
          `Therefore, in order to create a coherent performance, the performer must “allow this coherence to be heard”<span class="footnote">12</span>.`,
